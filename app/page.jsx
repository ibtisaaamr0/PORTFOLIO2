  ...
  return (
    ...
    <motion.div
      ...
      <main className="min-h-xs flex flex-col justify-center items-center bg-transparent px-10 py-10 gap-15 mb-40">
        ...
        <div className="rounded-full md:rounded-xl flex flex-col-reverse gap-10 md:flex-row items-center justify-between max-w-xs xs:w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl mt-5 shadow-2xl p-4 lg:p-10 bg-transparent md:mt-30">

          <div className="text-left ">
            <h1 className="text-xl lg:text-2xl font-bold text-gray-900 typing-animation">Hey, I’m Ibtisam </h1>
            ...
            <button className="bg-black text-white p-2 lg:p-4 max-w-xs xs:w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl rounded-full shadow-lg object-cover hover:bg-white hover:text-black "><Link href={"/contact"}>Get in touch</Link></button>
            <button className="p-2 lg:p-4 rounded-full shadow-lg object-cover text-white bg-black hover:bg-white hover:text-black"><Link href={"/projects"}>Projects</Link></button>
            </div>
          </div>
        ...
        <div className="rounded-full md:rounded-xl flex flex-col-reverse gap-5 lg:flex-col-reverse items-center justify-between max-w-xs xs:w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl mt-5 shadow-2xl p-5 bg-transparent md:mt-30">
          ...
          <div className=" md:text-left flex flex-col justify-center items-center gap-5 max-w-xs xs:w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl ">
            <h1 className="text-base sm:text-xl font-bold text-gray-900 flex gap-5">About Me <FcAbout /></h1>
            ...
            <button className="bg-black text-white p-3 m-0 rounded-full shadow-lg object-cover hover:bg-white hover:text-black"><Link href={"/contact"}>Get in touch</Link></button>

            <button className="bg-red-600 text-white p-3 m-0 rounded-full shadow-lg object-cover hover:bg-white hover:text-black"><Link href={"/sample-resume.pdf"}>My resume</Link></button>
            </div>
          </div>
